...
*/
var CACHE_NAME = '<?php echo $shortname; ?>-cache-<?php echo str_replace('.', '-', $version); ?>';
var urlsToCache = [
  '<?php echo $servidor.$ruta; ?>',
  '<?php echo $servidor.$ruta; ?>w3.css',
  '<?php echo $servidor.$ruta; ?>img/favicon.png',
  '<?php echo $servidor.$ruta; ?>img/launcher-icon-512.png',
  '<?php echo $servidor.$ruta; ?>img/launcher-icon-1x.png',
  '<?php echo $servidor.$ruta; ?>img/launcher-icon-2x.png',
  '<?php echo $servidor.$ruta; ?>img/launcher-icon-4x.png'
];
...
self.addEventListener('activate', function(event) {
  ...
  var cacheWhitelist = ['<?php echo $shortname; ?>-cache-<?php echo str_replace('.', '-', $version); ?>']; //, 'blog-posts-cache-v1'];
